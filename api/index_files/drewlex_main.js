...
function initFeatures(settings) {
    ...
    if (!settings.formApi || !settings.formApi.isNeeded) {
        var featuresFilesSrc = (window.location.protocol == 'file:') ? {
                 userAva: 'index_files/autoCommentsAva.jpg',
            refreshingArrow: 'index_files/autoCommentsRefreshing.gif',
            autoCommStyles: 'index_files/autoComments.css',
            popupsStyles: 'index_files/popups.css',
            popupsIconUser: 'index_files/count-user_black.png',
            popupsIconOrder: 'index_files/count-order-984_black.png',
            prizeWheel: 'index_files/prizewheel.png',
            wheelCursor: 'index_files/wheel-cursor.png',
            wheelStyles: 'index_files/wheel.css',
            formStyles: 'index_files/formStyles.css'
        } : {
                 userAva: 'index_files/autoCommentsAva.jpg',
            refreshingArrow: 'index_files/autoCommentsRefreshing.gif',
            autoCommStyles: 'index_files/autoComments.css',
    ...
    function genLocalForm () {
        var localForms = {
           ...
           'pl' : '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Opłacalne!</span> <s><span class="js_old_price price_old">' + priceMain * 2 + currencyMain + '</span></s><br> <b class="new_price js_new_price price_main">' + priceMain + currencyMain + '</b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pospiesz się, aby zamówić z rabatem, aż oferta zostanie przekazana do następnego czytelnika! <br>Oferta straci ważność po:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="" method="POST"> <select class="country_select wheel_input" name="country">' + ((!!settings.formApi && settings.formApi.isNeeded) ? formApiCode : '</select>')  + ' <label for="name" class="data_label">Twoje imię i nazwisko:</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Tom Czerniak "><label for="phone" class="data_label">Numer telefonu:</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+48 123456789"> <input type="hidden" name="landing" value="' + ((!!settings.formApi && settings.formApi.isNeeded) ? settings.formApi.landingValue : window.location.host) + '"> <button class="main-link" type="submit">ZAMÓWIĆ ' + settings.product + ' z 50% zniżką!</button> </form> </div><center> <h2 class="time_remains_title">Oferta ważna do (włącznie):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
            ...
            'cz' : '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Speciální nabídka</span> <s><span class="js_old_price price_old">1580 Kč</span></s><br> <b class="new_price js_new_price price_main">790 Kč</b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Stíhnete si objednat se slevou, zatím nabídka nepřešla k jinému čtenářovi! <br>Nabídka vyprší za: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="post.php" method="POST"> <select class="country_select wheel_input" name="country">' + ((!!settings.formApi && settings.formApi.isNeeded) ? formApiCode : '</select>')  + ' <label for="name" class="data_label">Uveďte jméno a příjmení</label><input class="wheel_input" type="text" name="name" required="" id="name" placeholder="Pavel Smejkal"><label for="phone" class="data_label">Uveďte tel.číslo</label> <input class="wheel_input" type="text" id="phone" name="phone" required="" placeholder="+420 123456789">  <button class="main-link" type="submit">OBJEDNAT ' + settings.product + ' SE SLEVOU 50%!</button> </form> </div><center> <h2 class="time_remains_title">Pozor, akce se speciální slevou trvá pouze do  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
